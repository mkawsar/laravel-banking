                            ...
                            <div class="filter-bar" style="margin-bottom: 10px">
                                <form class="form-inline">
                                    ...
                                    <button class="btn btn-success btn-sm pull-right"
                                            type="button"
                                            @click="handleMemberSavingsWithdrawHistoryDownload">Download
                                    </button>
                                </form>
                            </div>
...
export default {
    ...
    data() {
        return {
            ...
            url: this.$env.BACKEND_API + `admin/accounting/member/${this.$route.params.memberID}/savings/withdraw/list`,
    ...
    methods: {
        ...
        doFilter() {
            if (this.filterText === '') {
                this.url = this.$env.BACKEND_API + `admin/accounting/member/${this.$route.params.memberID}/savings/withdraw/list`;
            } else {
                let date = this.$moment(this.filterText).format('Y-MM-DD H:m:s');
                this.url = this.$env.BACKEND_API + `admin/accounting/member/${this.$route.params.memberID}/savings/withdraw/list?search=${date}`;
            }
        },
        resetFilter() {
            this.filterText = '';
        ...
        handleMemberSavingsWithdrawHistoryDownload() {
            window.location.href = this.$env.BACKEND_API + `admin/accounting/member/${this.$route.params.memberID}/savings/withdraw/history/download`;
        }
    },
    mounted() {
